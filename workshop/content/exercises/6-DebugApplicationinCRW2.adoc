...
Delve is a debugger for the Go programming language. We will need it to debug our application. Change to your root directory and follow the installation instructions found here https://github.com/go-delve/delve/blob/master/Documentation/installation/linux/install.md

...
Delve is a debugger for the Go programming language. We will need it to debug our application. Open a terminal and change to your root directory. Follow the https://github.com/go-delve/delve/blob/master/Documentation/installation/linux/install.md[installation instructions for Delve].

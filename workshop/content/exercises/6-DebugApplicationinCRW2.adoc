...
* Completed link:exercises/5-RedHatCodeReadyWorkspaces2[Deploy Golang App on Red Hat CodeReady Workspaces 2.2]
...
* Using the application deployed in Excerise link:exercises/5-RedHatCodeReadyWorkspaces2[5. Deploy Golang App on Red Hat CodeReady Workspaces 2.2] we will debug and then deploy the application to OpenShift

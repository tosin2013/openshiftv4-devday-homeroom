...
Run the command below to get the status of the pipeline run 
----
$ tkn pipelinerun  list
NAME                            STARTED          DURATION    STATUS
multi-project-pipeline-qzv2et   23 minutes ago   3 minutes   Succeeded
----

Run the comand below to talk the logs of the pipeline build.
----
